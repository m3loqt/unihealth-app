...
<head>
  ...
  <style>
    ...
    .unfit-period { margin: 16px 0; padding: 16px; background: #FEF2F2; border-left: 4px solid #EF4444; border-radius: 4px; }
    .unfit-period-title { font-size: 16px; font-weight: 700; color: #DC2626; margin-bottom: 8px; }
    .unfit-period-dates { font-size: 15px; color: #374151; }
    ...
    <div class="page">
      ...
      <div class="body">
        ...
        <div class="certificate-content">
          <p>This is to certify that <strong>${patientName}</strong>, ${ageText}, ${gender}, was seen and treated on <strong>${examinationDate}</strong> and is advised to rest and refrain from work/school activities.</p>
          
          <div class="unfit-period">
            <div class="unfit-period-title">Period of Unfitness</div>
            <div class="unfit-period-dates">
              <strong>From:</strong> ${unfitPeriodStart}<br/>
              <strong>To:</strong> ${unfitPeriodEnd}
            </div>
          </div>
          ...
          ${followUpDate && followUpDate !== '—' ? `<p><strong>Follow-up Date:</strong> ${followUpDate}</p>` : ''}
          
          <p>This certificate is issued for medical leave purposes and confirms that the patient requires rest and medical attention during the specified period.</p>
        </div>
